...
namespace GoFishUnitTests
{
    ...
    public class GameStateTests
    {
        ...
        public void TestConstructor()
        {
            ...
            foreach (var player in gameState.Players.Select(player => player.Name).ToList())
        ...
        public void TestPlayRound()
        {
            ...
            Assert.AreEqual("Owen asked Brittney for Jacks" + 
                Environment.NewLine + "Brittney has 1 Jack card", message);
            ...
            Assert.AreEqual("Brittney asked Owen for Sixes" + 
                Environment.NewLine + "Owen has 2 Six cards", message);
            Assert.AreEqual(1, owen.Books.Count());
            Assert.AreEqual(2, owen.Hand.Count());
